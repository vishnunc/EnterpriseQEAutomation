...
public class COO_MyCustomersPage {
	...
	public void validateCustomerDetails() {
		...
		String PhoneNumber = world.driver.findElement(By.xpath(elementLib.getString("textdata_Phone"))).getText();
		if(!world.getCustomerDetails().get("Phone").equalsIgnoreCase(PhoneNumber)){
			throw new RuntimeException("PhoneNumber did not match");
		}
		
		//validate Email
		String Email = world.driver.findElement(By.xpath(elementLib.getString("textdata_Email"))).getText();
