...
@CucumberOptions(glue = {"com.beachbody.automation.stepdefs","com.beachbody.automation.hooks"}, plugin = {"json:target/json-cucumber-reports/cukejson.json",
		...
		"html:target/reports/htmlreport","json:target/cucumber.json","html:target/site/cucumber-pretty"}, features = "src\\test\\resources\\features\\e2e\\BYDCustomerDetails.feature")
